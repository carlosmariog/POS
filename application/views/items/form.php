...
if(($item_id ==-1)||($item_id ==-2)){?>
	<div class="field_row clearfix">
	<?php echo form_label($this->lang->line('items_serial_number').':', 'serial_number', array('class'=>'wide')); ?>
		<div class='form_field'>
		<?php echo form_input(array(
			'name'=>'serial_number',
			'id'=>'serial_number',
			'value'=>$item_info->serial_number)
		);?>
		</div>
	</div>
<?php 
...
<?php echo form_label($this->lang->line('items_category').':', 'category',array('class'=>'required wide')); ?>
	...
	<?php echo form_input(array(
		'name'=>'category',
		'id'=>'category',
		'value'=>$this->Item->get_category_name($item_info->category_id))
	);?>
	</div>
</div>
...
<?php 
	if($mode=='buy')
	{
		...
		echo form_label($this->lang->line('items_supplier').':', 'supplier',array('class'=>'required wide')); 		
	}	
?>
	<div class='form_field'>
	<?php
...
<?php echo form_hidden('reorder_level', 0); ?>
...
<?php echo form_hidden('allow_alt_description', 0); ?>
...
<?php echo form_hidden('items_is_serialized', 1); ?>

<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('items_barcodes_numbers').':', 'barcodes',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'barcodes',
		'id'=>'barcodes',
		'value'=>$item_info->barcodes_to_generate)
	);?>
	</div>
</div>
