...
<div id="report_summary">
	<?php foreach($overall_summary_data as $name=>$value) { ?>
		<?php if($title == 'Open'){ ?>
			<?php if($name == 'total'){ ?>		
				<div class="summary_row"><?php echo $this->lang->line('reports_subtotal'). ': '.to_currency($value); ?></div>	
				<div class="summary_row"><?php echo $this->lang->line('reports_deposit'). ': '.to_currency($deposit); ?></div>
				<div class="summary_row"><?php echo $this->lang->line('reports_total'). ': '.to_currency($value-$deposit); ?></div>				
			<?php }?>	
		<?php }else{ ?>		
