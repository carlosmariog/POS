...
<ul id="report_list">
	...
	<li><h3><?php echo $this->lang->line('reports_summary_reports'); ?></h3>
		<ul>
			<li><a href="<?php echo site_url('reports/summary_police');?>"><?php echo $this->lang->line('reports_police'); ?></a></li>
	...
	<li><h3><?php echo $this->lang->line('reports_detailed_reports'); ?></h3>
		<ul>
			...
			<li><a href="<?php echo site_url('reports/specific_employee_tracking');?>"><?php echo $this->lang->line('reports_employee_tracking'); ?></a></li>
