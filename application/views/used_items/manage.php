...
$(document).ready(function()
{
    ...
    $('#generate_barcodes').click(function()
    {
    	...
    	{
    		alert('<?php echo $this->lang->line('used_items_must_select_item_for_barcode'); ?>');
    		return false;
    	}
...
<div id="title_bar">
	...
	<div id="new_button">
		<?php
		echo $this->lang->line($controller_name.'_new');
...
<div id="table_action_header">
	<ul>
		...
		<li class="float_left"><span><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','title'=>$this->lang->line('used_items_edit_multiple_items'))); ?></span></li>
		<li class="float_left"><span><?php echo anchor("$controller_name/generate_barcodes",$this->lang->line("items_generate_barcodes"),array('id'=>'generate_barcodes', 'target' =>'_blank','title'=>$this->lang->line('used_items_generate_barcodes'))); ?></span></li>
