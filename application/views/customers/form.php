...
echo 'customers/save/'.$person_info->person_id;
?>
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('customers_banned').':', 'banned'); ?>
	<div class='form_field'>
	<?php echo form_checkbox('banned', '0', $person_info->taxable == '' ? FALSE : (boolean)$person_info->banned);?>
	</div>
</div>
