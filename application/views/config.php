...
<div id="new_button_config">
		<?php echo anchor("config/stores",
		"<div class='big_button' style='float: left; '><span>".'Stores Mgt'."</span></div>",
		array('title'=>'Stores Mgt'));
		?>
</div>	
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_buy_policy').':', 'buy_policy',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_textarea(array(
		'name'=>'buy_policy',
		'id'=>'buy_policy',
		'rows'=>'4',
		'cols'=>'17',
		'value'=>$this->config->item('buy_policy')));?>
	</div>
</div>
...
<?php echo form_hidden('language', 'english'); ?>
