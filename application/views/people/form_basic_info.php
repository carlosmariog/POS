...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_identification_type').':', 'identification_type'); ?>
	<div class='form_field'>
	<?php
		$options = array(
	 	...
	 	echo form_dropdown('identification_type', $options, 'passport');
	 ?>
	</div>
</div>

<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_identification_number').':', 'identification'); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'identification',
		'id'=>'identification',
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('desired_items').':', 'desired_items'); ?>
	<div class='form_field'>
	<?php echo form_textarea(array(
		'name'=>'desired_items',
		'id'=>'desired_items',
		'value'=>$person_info->desired_items,
		'rows'=>'5',
		'cols'=>'17')		
	);?>
	</div>
