...
function get_item_data_row($item,$controller)
{
	...
	if((substr($start_data,0,4)-substr($end_data,0,4))>0)	$price_check = false;
	elseif((substr($start_data,5,2)-substr($end_data,5,2))>0) $price_check = false;
	...
	if(!$price_check){
		$table_data_row.='<td width="14%">'.'X'.'</td>';
	}else{
