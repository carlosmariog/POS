...
<div id="receipt_wrapper">
	...
	<th style="width:25%;"><?php echo $this->lang->line('sales_item_serial_number'); ?></th>
	...
	<?php if($this->session->userdata('buy_repair_transaction')>0) { ?>
		<div id="sale_return_policy">
		<?php echo nl2br($this->config->item('buy_policy')); ?>
		</div>
	<?php } ?>
...
while(name != '<?php echo $this->session->userdata("password"); ?>'){
	var name=prompt('Please enter your password');
}	

location.href = "/pos/index.php/home";
