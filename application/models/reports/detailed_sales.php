...
class Detailed_sales extends Report
{
	...
	public function getData(array $inputs)
	{
		...
		{
			$this->db->select('sales_items_temp.name, category_id, quantity_purchased, serialnumber, sales_items_temp.description, subtotal,total, tax, profit, discount_percent');
			$this->db->from('sales_items_temp');
